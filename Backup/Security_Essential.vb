...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.txtConPassEncrypt.Text = "Kingbob1234"
        '
        'txtPassEncrypt
        '
        ...
        Me.txtPassEncrypt.Text = "Kingbob1234"
        '
        'Label1
        '
        ...
        Me.ListBox1.Location = New System.Drawing.Point(390, 22)
        ...
        Me.ClientSize = New System.Drawing.Size(647, 231)
...
#End Region
    ...
    Private Sub frmMain_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        thefiles = Directory.GetFiles("j:\kingbob\")
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        Try
            ...
            totallist = ListBox1.Items.Count

            For list As Integer = 0 To totallist - 1
                txtFileToEncrypt.Text = ListBox1.Items(list).ToString
                txtDestinationEncrypt.Text = ListBox1.Items(list).ToString & ".encrypt"
                strFileToEncrypt = OpenFileDialog.FileName
                txtFileToEncrypt.Text = strFileToEncrypt
